...
//  WordScramble
//
//  Created by Екатерина Чернова on 09.01.2021.
//
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        NavigationView {
            VStack {
                TextField("Enter your word", text: $newdWord, onCommit: addNewWord)
    ...
    func addNewWord() {
        let answer = newdWord.lowercased().trimmingCharacters(in: .whitespacesAndNewlines)
    ...
    func getScore() {
        ...
        finalScore += usedWord.first?.count ?? 0
       
//        for i in 0 ..< usedWord.count {
//
//           finalScore += usedWord[i].count
//
//        }

        print (finalScore, usedWord.count, usedWord)
